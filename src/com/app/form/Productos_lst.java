...
public class Productos_lst extends frm_Padre {
    ...
    private ResultSet traerDatos() {
        String[] campo = new String[]{this.cod_empresa, this.cod_sucursal, idConsultada};
        String[] nombres = new String[]{"codigo", "descripcion", "referencia"};
        String[] campoCondicion = {this.cod_empresa, this.cod_sucursal, idConsultada, idConsultada};
        String[] igual = {"=", "=", ">=", "<="};
